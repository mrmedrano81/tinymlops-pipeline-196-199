...
python train.py \
    ...
    --summaries_dir work/DS_CNN/DS_CNN_S/retrain_logs \
    --train_dir work/DS_CNN/DS_CNN_S/training \
    --data_dir dataset
fi
...
xxd -i ds_cnn_quantized.tflite > ds_cnn_quantized.cpp
sed -i 's/ds_cnn_quantized_tflite/g_ds_cnn_quantized/g' ds_cnn_quantized.cpp
